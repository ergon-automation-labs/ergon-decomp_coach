defmodule BotArmyDecompCoach.Skills.Example do
  @moduledoc """
  Example skill for Decomposition Coach Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_decomp_coach.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_decomp_coach.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_decomp_coach/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_decomp_coach.command.example"
    ]
  end
