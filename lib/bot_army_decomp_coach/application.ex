defmodule BotArmyDecompCoach.Application do
  @moduledoc """
  Decomposition Coach Bot application supervisor.
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: BotArmyDecompCoach.Supervisor]
  ...
  defp maybe_add_repo(children) do
    if @env == :test do
      ...
      [{BotArmyDecompCoach.Repo, []} | children]
    end
  end
  ...
  defp maybe_add_pulse_publisher(children) do
    if @env == :test do
      ...
      [{BotArmyDecompCoach.PulsePublisher, []} | children]
    end
  end
