defmodule BotArmyDecompCoach.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Decomposition Coach Bot.
  ...
  2. **`bot.decomp_coach.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "decomp_coach"
  @envelope_source "bot_army_decomp_coach"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Decomposition Coach Bot pulse publisher")
