...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/decomp_coach_bot
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/decomp_coach_bot/"
	@echo ""
...
publish-release: release
	...
	TARBALL="decomp_coach_bot-$$VERSION.tar.gz"; \
	echo "Version: $$VERSION"; \
	echo "Creating release tarball..."; \
	tar -czf "$$TARBALL" -C _build/prod/rel decomp_coach_bot/; \
	...
	if gh release view "v$$VERSION" >/dev/null 2>&1; then \
		...
		gh release create "v$$VERSION" "$$TARBALL" \
			...
			--notes "Decomposition Coach Bot Elixir release v$$VERSION. Download and deploy with Jenkins." \
			--draft=false; \
	fi; \
	...
	BOT_SHORT=$$(echo "decomp_coach_bot" | sed 's/_bot$$//'); \
